...
<head>
    ...
    <title>{{ __('client.client_auth.activation_email_subject') }}</title>
    <style>
        ...
        .footer { background: #f3f4f6; padding: 20px 30px; border-radius: 0 0 8px 8px; color: #6b7280; font-size: 13px; border: 1px solid #e5e7eb; border-top: none; }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            ...
            @endif
            <h2>{{ __('client.client_auth.activation_email_subject') }}</h2>
        </div>
        ...
        <div class="content">
            ...
            <div class="message-box">
                <p class="message-text">{{ __('client.client_auth.activation_message') }}</p>
            </div>

            <!-- Time Limit -->
            <div class="alert-box">
                <strong>⏱️ {{ __('client.client_auth.activation_expires', ['date' => $expiresAt]) }}</strong>
            </div>

            <!-- Action -->
            <div style="text-align: center;">
                <a href="{{ $activationUrl }}" class="action-button">
        ...
        <div class="footer">
            <p style="margin: 0 0 12px 0; padding-bottom: 12px; border-bottom: 1px solid #e5e7eb;">
